    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_total', models.DecimalField(default=0, decimal_places=2, verbose_name=b'Valor Total', max_digits=10, db_column=b'valor_total')),
                ...
                ('machinecard', models.ForeignKey(related_name=b'sales_credit_debit_machinecard', db_column=b'machinecard', verbose_name=b'Maquina de Cart\xc3\xa3o', to='payments.MachineCard')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machinecard', models.ForeignKey(related_name=b'taxa_machine_card', db_column=b'machinecard', verbose_name=b'Maquina Cart\xc3\xa3o', to='payments.MachineCard')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.AddField(
            ...
            name='tipo',
            field=models.ForeignKey(related_name=b'taxa_machine_card_tipo', db_column=b'tipo', verbose_name=b'Tipo Taxa', to='payments.TipoCreditDebit'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='salescreditdebit',
            name='status',
            field=models.ForeignKey(related_name=b'credit_debit_status', db_column=b'status', verbose_name=b'Status Venda', to='payments.StatusCreditDebit'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='salescreditdebit',
            name='tipo',
            field=models.ForeignKey(related_name=b'sales_credit_debit_tipo', db_column=b'tipo', verbose_name=b'Tipo Venda', to='payments.TipoCreditDebit'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='detailsalescreditdebit',
            name='sale_credit_debit',
            field=models.ForeignKey(related_name=b'detail_credit_debit', db_column=b'sale_credit_debit', verbose_name=b'Cod Sale Credit Debit', to='payments.SalesCreditDebit'),
            preserve_default=True,
        ),
    ]
